...
\Description{
\begin{itemize}
  \item[\footnotesize$\bullet$] Was in charge of hiring and training employees.
  ...
  \item[\footnotesize$\bullet$] Mentored team leads in people and
    project management.  
  \item[\footnotesize$\bullet$] Was responsible for product ideation and
    market expansion.
  \item[\footnotesize$\bullet$] Managed interaction with corporate
...
\Description{
\begin{itemize}
  \item[\footnotesize$\bullet$] Managed project management,
    project/issue tracking and people management and day-to-day task delegation
  ...
  \item[\footnotesize$\bullet$] Managed and delegated development support for customer issues.
  ...
  \item[\footnotesize$\bullet$] Was in charge of technical recruitment and induction.
...
\vspace{0.5em}
  \textsl{Role and responsibility:} {\scriptsize Conducted the requirement analysis and
...
\vspace{0.5em}
\textsl{Technologies used:} {\scriptsize Ruby, SMTP, Linux dialog, Python, Sqlite, Ubuntu Linux}
...
\vspace{0.5em}
\textsl{Role and responsibility:} {\scriptsize Conducted the requirement
  ...
  Erlang module.}\\
\vspace{0.5em}
\textsl{Technologies used:} {\scriptsize Ruby, Erlang, Erlectricity, SMTP, Linux dialog, Ubuntu
...
\item[\footnotesize$\bullet$] \textbf{Configurator: }{\scriptsize The Ilio Configurator is an installer/configuration generator.
  ...
  \vspace{0.5em}
  \textsl{Technologies used:} {\scriptsize Ruby, Shoes}
\end{itemize}
}
